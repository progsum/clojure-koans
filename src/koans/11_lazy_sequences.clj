...
(meditations
  ...
  (= '(1 2 3 4) (range 1 5)) ;no surpises here? 1-4

  "The range starts at the beginning by default"
  (= '(0 1 2 3 4) (range 5)) ;0-4
  ...
  (= '(1 2 4 8 16 32 64 128) (take 8 (iterate (fn [x] (* x 2)) 1))) ;this is good tool ;)
...
;     (take 100 (iterate (fn [x] (str x)) "hello"))))
     (take 100 (iterate (fn [x] x) "hello"))));used (x), so had to add the str
